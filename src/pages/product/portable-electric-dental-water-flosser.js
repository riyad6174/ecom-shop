            ...
            <div className='w-full lg:w-2/5 px-4 sm:px-6 py-4'>
              ...
              <div className='flex items-center justify-start gap-4 mb-6'>
                ...
                <button
                  ...
                  className='flex items-center bg-blue-600 text-white justify-center gap-2 border border-blue-600 px-4 sm:px-6 py-2 sm:py-3 rounded-md font-mont font-semibold text-sm hover:bg-blue-700 transition duration-300'
