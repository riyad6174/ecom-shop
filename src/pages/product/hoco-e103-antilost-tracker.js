...
const productData = products.find(
  (p) => p.slug === 'hoco-e103-antilost-tracker',
);

const HOCO_IMG = '/assets/product/tracker/hoco-e103-product-dark-floating.png';

const useCases = [
  { Icon: FaMotorcycle, title: 'বাইক চুরি', desc: 'রাতে গ্যারেজ থেকে সরিয়ে নিলে ফোনে শেষ লোকেশন দেখুন' },
  { Icon: FaBicycle, title: 'বাইসাইকেল হারালে', desc: 'কলেজ/বাজার থেকে হারিয়ে গেলে ম্যাপে খুঁজে নিন' },
  { Icon: FaCar, title: 'সিএনজি চুরি', desc: 'ভাড়ায় গিয়ে ফেরত না এলে বা চুরি হলে লোকেশন ট্র্যাক' },
  { Icon: FaTaxi, title: 'অটো হারালে', desc: 'স্ট্যান্ড বা রাস্তায় হারিয়ে গেলে Ring বাজিয়ে খুঁজুন' },
...
const initialReviews = [
  { name: 'রাহিম', initials: 'র', badge: 'বাইক - চুরি থেকে বাঁচল', quote: 'গলি থেকে বাইক সরিয়ে নিয়েছিল, ফোনে লোকেশন দেখে ২ ঘণ্টায় খুঁজে পেয়েছি। ৯৯৯ টাকায় বড় বাঁচা।' },
  { name: 'সাবরিনা', initials: 'স', badge: 'সিএনজি মালিক', quote: 'ড্রাইভার রাতে সিএনজি নিয়ে কোথায় যায় টেনশন হতো, এখন ম্যাপে দেখি — চুরির ভয় অনেক কম।' },
  { name: 'তানভীর', initials: 'ত', badge: 'অটো চালক', quote: 'স্ট্যান্ডে অটো হারিয়ে গিয়েছিল, Ring বাজাতেই পাশের গলিতে পেয়ে গেলাম।' },
  { name: 'নাজমুল', initials: 'ন', badge: 'বাইসাইকেল', quote: 'কলেজ থেকে সাইকেল চুরি হয়েছিল ভেবেছিলাম, শেষ লোকেশন দেখে দারোয়ানের কাছে পেলাম।' },
  { name: 'ফারহানা', initials: 'ফ', badge: 'Support', quote: 'ভাইয়া বুঝিয়ে দিলেন সিটের নিচে কীভাবে লুকাতে হয় যাতে চোর না পায়।' },
  { name: 'ইমরান', initials: 'ই', badge: 'Value', quote: 'বাইক আর অটোর জন্য দুটি নিলাম ১৯৯৮ টাকায় — একটা চুরি ঠেকাতে পারলেই উসুল।' },
];

const faqData = [
  {
    q: 'চুরি হলে কীভাবে খুঁজে পাব?',
    a: 'গাড়িতে লুকানো ট্র্যাকার Apple Find My / Google Find Hub নেটওয়ার্কে শেষ লোকেশন পাঠায়। চুরি হলে ফোনে ম্যাপে লোকেশন দেখে পুলিশকে দেখাতে পারবেন। কাছে গেলে Ring বাজিয়ে সঠিক জায়গা চিহ্নিত করুন।',
  },
  {
    q: 'চোর ট্র্যাকার খুলে ফেললে?',
    a: 'এটা ছোট ও লুকানো ডিজাইন — সিটের নিচে, টুলবক্স বা ড্যাশবোর্ডের ভেতরে রাখলে চোর সহজে খুঁজে পায় না। HOCO E103-এ সিলিকন কভার থাকায় আরও টেকসই ও গোপন থাকে।',
  },
  {
    q: 'বাইক/সিএনজি/অটোতে কোথায় লুকিয়ে রাখব?',
  ...
  {
    q: 'হারিয়ে গেলে বা ভুলে রাখলে কী হবে?',
    a: 'হারালে বা পার্কিংয়ে ভুলে গেলে ফোনে “Play Sound” দিলে কাছাকাছি থাকলে Ring বাজবে, দূরে থাকলে ম্যাপে শেষ লোকেশন দেখাবে।',
  },
];
  ...
  return (
    <div className="flex items-center border border-white/20 rounded-lg overflow-hidden">
      <button
        ...
        className="px-4 py-2.5 text-white hover:bg-white/10 font-bold text-lg leading-none"
      >
        −
      </button>
      <span className="px-4 py-2.5 font-semibold text-white min-w-[44px] text-center text-sm">
        {quantity}
      </span>
      <button
        type="button"
...
const SetupSection = () => {
  ...
  const steps = [
    ...
    'গাড়িতে লুকিয়ে রেখে Ring / last-known-location test করুন।',
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        <div className="text-center mb-8">
          <h2 data-reveal className="text-2xl md:text-3xl font-extrabold text-white bangla mb-2">
            বাইক/অটোতে লাগিয়ে ফোনে connect করবেন কীভাবে?
          </h2>
          <p data-reveal data-reveal-delay="1" className="text-[#D9E1F2] bangla text-sm">
            Android দিয়ে HOCO E103 — ভিডিও দেখে ১ মিনিটেই pair করুন
          </p>
        </div>
        <div data-reveal="scale" className="bg-white/5 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden border border-white/10">
          ...
          <div className="p-6">
            <p className="text-sm font-bold text-white bangla mb-4 text-center">
              HOCO E103 — Android setup (১ মিনিট)
            </p>
            ...
            <p className="text-xs text-[#9BA8BF] bangla mt-4 bg-[#080B14] p-3 rounded-lg border border-white/10">টিপস: গাড়ির নাম দিন “আমার বাইক” / “আমার অটো” — পরে খুঁজতে সুবিধা হবে</p>
    ...
    <section className="bg-[#080B14] py-16">
      <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
        <h2 data-reveal className="text-2xl font-extrabold text-white bangla text-center mb-8">
          গাড়িতে রেখে connect না হলে reset কীভাবে?
        </h2>
  ...
  return (
    <section id="reviews" className="bg-[#0B1020] py-16">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <p className="text-center text-xs text-[#9BA8BF] bangla mt-3">সব {reviewImages.length}টি রিভিউ ছবি লোড করা হয়েছে — স্ক্রল করলে lazy-load হবে</p>
        <div className="text-center mt-6 flex flex-col items-center gap-3">
          ...
          >
            অন্যরা ব্যবহার করছেন—এবার আপনিও অর্ডার করুন
          </button>
        </div>
      </div>
    </section>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
            {[
              ...
              { text: 'তার কাটাকাটির প্রয়োজন নাই', ok: false },
        ...
        <div className="relative">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-amber-200/70 text-xs bangla mt-1">ক্রয়ের আগে সত্যটা জানা জরুরি, তাই স্পষ্ট করে বলছি</p>
            </div>
          </div>
          <div className="bg-[#0B1020]/70 border border-amber-500/15 rounded-2xl p-5 mb-5">
            <p className="text-[#D9E1F2] bangla text-sm md:text-[15px] leading-relaxed">
              এটি আপনাকে <span className="text-white font-bold">লাইভ লোকেশন আপডেট দিতে পারবে না</span>, ডিভাইসটি আপনাকে <span className="text-white font-bold">লাস্ট লোকেশন আর টাইম জানাবে</span>। মার্কেটে অনেকেই আপনাকে হয়তো লাইভ লোকেশন এর কথা বলে বিক্রির চেষ্টা করবে।
            </p>
            <p className="text-[#9BA8BF] bangla text-sm leading-relaxed mt-3">
              ডিভাইসটি কিভাবে কাজ করে জানতে আমাদের কল করতে পারবেন — আমরা বুঝিয়ে দেব লাইভ vs লাস্ট লোকেশন এর পার্থক্য।
            </p>
          </div>
          <div className="text-center">
            <a
      ...
      >
        ...
        <div className="relative text-center">
          ...
          <p className="text-[#D9E1F2] bangla text-sm md:text-[15px] leading-relaxed mb-3">
            চিন্তার কারণ নেই। আমাদের অথেনটিক প্রোডাক্ট অবশ্যই কাজ করবে। <span className="text-white font-semibold">৭ দিন ব্যবহার করে</span> আপনার যদি মনে হয় কাজ করছে না — আপনি <span className="text-white font-semibold">কোনো কন্ডিশন ছাড়াই</span> প্রোডাক্ট রিটার্ন করে দিতে পারবেন।
          </p>
          <p className="text-[#9BA8BF] bangla text-sm leading-relaxed mb-6">
            হাজার হাজার ব্যবহারকারীরা এই ডিভাইসগুলো থেকে উপকৃত হয়েছেন — আপনিও হবেন ইনশাআল্লাহ।
          </p>
          <button
            type="button"
            onClick={() => {
          ...
          >
            প্রয়োজনে রিভিউ দেখুন <span aria-hidden>↓</span>
          </button>
        </div>
      </div>
    </div>
...
export default function HocoE103LandingPage({ product }) {
  ...
  const handleQtyChange = (action) => {
    setQuantity((current) => {
      if (action === 'increment' && current < 99) return current + 1;
      if (action === 'decrement' && current > 1) return current - 1;
      return current;
    });
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta property='og:image' content={HOCO_IMG} />
      ...
      <div className="sticky top-0 z-30 bg-[#080B14]/95 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-4 lg:px-8 py-2 flex items-center justify-between">
          <span className="text-sm font-bold text-white bangla">HOCO E103 Tracker — ৳৯৯৯ টাকা</span>
          <button
            type="button"
            onClick={() => {
              const el = document.getElementById('product-selection');
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#D9E1F2] text-base md:text-lg bangla mb-6 leading-relaxed hero-animate-2">
              আপনার পছন্দের বাইক, সাইকেল কিংবা আপনার সিএনজি কিংবা অটোরিক্সা হারিয়ে গেলে আপনি আপনার ফোন থেকেই যদি লোকেশন জেনে যেতে পারতেন কত সুবিধা হতো না?
              <span className="block mt-4 text-white font-semibold">HOCO E103 — নিচে বিস্তারিত শেয়ার করছি, দেখুন তো কাজের প্রোডাক্ট কিনা?</span>
            </p>
      ...
      <section id="product-selection" className="bg-gradient-to-b from-[#080B14] to-[#0B1020] py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            <h2 data-reveal className="text-2xl md:text-3xl font-extrabold text-white bangla mb-2">চুরি/হারানোর আগেই অর্ডার করুন</h2>
            <p data-reveal data-reveal-delay="1" className="text-[#9BA8BF] bangla text-sm">HOCO E103 — বাইক/অটো/সাইকেল সবকিছুতেই লুকিয়ে রাখা যাবে</p>
          </div>
          <div data-reveal data-reveal-delay="2" className="max-w-md mx-auto">
            <div className="rounded-2xl border-2 border-transparent bg-gradient-to-br from-violet-600/20 to-cyan-500/20 shadow-[0_0_20px_rgba(124,58,237,0.25)] p-5 md:p-6">
              ...
              <div className="relative w-full h-48 md:h-56 mb-4 rounded-xl overflow-hidden bg-[#0B1020] border border-white/10 p-2">
                <Image src={HOCO_IMG} alt="HOCO E103 Anti-Lost Tracker" fill className="object-contain float-img" sizes="(max-width: 768px) 100vw, 50vw" />
              </div>
              <h3 className="text-lg font-bold text-white bangla mb-1 leading-tight">{product.title}</h3>
              <p className="text-sm text-[#D9E1F2] bangla mb-3">
                অটো/সিএনজির ড্যাশবোর্ডে বা বাইকের সিটের নিচে লুকিয়ে রাখুন — চুরি হলে লোকেশন দেখুন
              </p>
              <ul className="space-y-1 mb-4">
                <li className="text-xs text-[#9BA8BF] bangla">• চুরি/হারালে ফোনে লোকেশন ট্র্যাক</li>
                <li className="text-xs text-[#9BA8BF] bangla">• কাছে থাকলে Ring বাজিয়ে খুঁজুন</li>
                <li className="text-xs text-[#9BA8BF] bangla">• Apple Find My + Google Find Hub — উভয় ফোনে চলে</li>
              </ul>
              <div className="flex items-center justify-between pt-3 mb-4 border-t border-white/10">
                <span className="text-lg font-extrabold text-white">৳৯৯৯ <span className="text-sm font-normal text-[#9BA8BF]">টাকা</span></span>
                <QuantityStepper quantity={quantity} onChange={handleQtyChange} />
              </div>
              <button
                type="button"
              ...
              >
                {product.inStock ? 'এখনই অর্ডার করুন' : 'স্টক নেই'}
              </button>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { Icon: FaCheckCircle, title: 'আসল পণ্য', desc: 'চেক করে পাঠানো হয়' },
              { Icon: FaSearch, title: 'গোপনে লুকানো যায়', desc: 'ছোট, চোর সহজে পাবে না' },
      ...
      <section className="bg-[#080B14] py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-10">
            <h2 data-reveal className="text-2xl md:text-3xl font-extrabold text-white bangla mb-2">চুরি বা হারিয়ে গেলে — ফোনেই খুঁজে পাওয়ার সুযোগ</h2>
            <p data-reveal data-reveal-delay="1" className="text-[#9BA8BF] bangla text-sm max-w-2xl mx-auto">গাড়ি চুরি হলে বা রাস্তায় হারিয়ে গেলে — নেটওয়ার্কের মাধ্যমে সারা দেশে শেষ লোকেশন দেখুন, কাছে গেলে Ring বাজিয়ে সঠিক জায়গা চিহ্নিত করুন</p>
          </div>
      ...
      <section className="py-16 bg-[#080B14]">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-extrabold text-white bangla mb-2">চোরের আগেই প্রস্তুত থাকুন — আজই লুকিয়ে রাখুন</h3>
            <p className="text-white/80 bangla text-sm md:text-base mb-6">চুরি/হারানোর পরে আফসোস নয় — এখনই বাইক/অটোতে লুকিয়ে রাখুন, মাত্র ৳৯৯৯ টাকা, ব্যাটারি ৬-৮ মাস</p>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#080B14]/95 backdrop-blur-md border-t border-white/10 md:hidden safe-area-pb">
        <div className="flex items-center justify-between px-4 py-3 gap-3">
          <div className="text-sm">
            <p className="text-white font-bold bangla">৳{(product.price || 0) * quantity} টাকা</p>
            <p className="text-[#9BA8BF] text-xs bangla">HOCO E103 — {quantity}টি</p>
          </div>
          <button
            type="button"
            onClick={handleCheckout}
            disabled={isAdding || !product.inStock}
            className="flex-shrink-0 font-bold px-5 py-3 rounded-xl text-sm bangla transition-all bg-gradient-to-r from-violet-600 to-cyan-500 text-white shadow-lg disabled:opacity-50"
          >
            Checkout →
          </button>
        </div>
